...
DEMO_PAYMENT_ENABLED = config('DEMO_PAYMENT_ENABLED', default=True, cast=bool)

BASE_URL = config('BASE_URL', default='http://localhost:8000')
SSLCOMMERZ_SUCCESS_URL = BASE_URL + '/payments/success/'
SSLCOMMERZ_FAIL_URL = BASE_URL + '/payments/fail/'
SSLCOMMERZ_CANCEL_URL = BASE_URL + '/payments/cancel/'
SSLCOMMERZ_IPN_URL = BASE_URL + '/payments/ipn/'
DEMO_PAYMENT_URL = BASE_URL + '/payments/demo/otp/'
